...
import { and, Database, eq, isNull } from "@overcode-ai/console-core/drizzle/index.js"
import { BillingTable, LiteTable } from "@overcode-ai/console-core/schema/billing.sql.js"
    ...
    return new Response(
      JSON.stringify({
        ...
        error: {
          ...
          message: "Overcode Go subscription required.",
        },
      }),
      {
        status: 403,
