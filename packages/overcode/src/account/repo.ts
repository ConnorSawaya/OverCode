...
import { AccountStateTable, AccountTable } from "@overcode-ai/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@overcode/AccountRepo") {}
