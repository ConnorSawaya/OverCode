...
import { openEditor } from "@overcode-ai/tui/editor"
import { registerOvercodeKeymap } from "@overcode-ai/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerOvercodeKeymap(keymap, renderer, input.tuiConfig)
