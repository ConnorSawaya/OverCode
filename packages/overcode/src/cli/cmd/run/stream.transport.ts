...
import type { Event, GlobalEvent, OpencodeClient } from "@overcode-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@overcode/RunStreamTransport") {}
