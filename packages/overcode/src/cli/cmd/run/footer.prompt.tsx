...
import { normalizePromptContent } from "@overcode-ai/tui/editor"
...
import { OVERCODE_BASE_MODE, useBindings } from "@overcode-ai/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close Overcode" } satisfies SlashOption,
    ]
