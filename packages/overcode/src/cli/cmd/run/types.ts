// Shared type vocabulary for the direct interactive mode (`overcode --mini`).
//
...
import type { OpencodeClient, PermissionRequest, QuestionRequest, ToolPart } from "@overcode-ai/sdk/v2"
