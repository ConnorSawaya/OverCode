...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@overcode-ai/plugin"
...
export function webSearchEnabled(providerID: ProviderV2.ID, flags = { exa: false, parallel: false }) {
  return (
    ...
    providerID === ProviderV2.ID.make("overcode-go") ||
    flags.exa ||
    flags.parallel
  )
}
...
export class Service extends Context.Service<Service, Interface>()("@overcode/ToolRegistry") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const rename = yield* SessionRenameTool
