import type { Hooks, PluginInput } from "@overcode-ai/plugin"
import type { Model } from "@overcode-ai/sdk/v2"
import { InstallationVersion } from "@overcode-ai/core/installation/version"
import { OauthCallbackPage } from "@overcode-ai/core/oauth/page"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. Overcode will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
