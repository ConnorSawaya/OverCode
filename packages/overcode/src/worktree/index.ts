...
import { path } from "@overcode-ai/core/effect/app-node-platform"
...
import type { ProjectV2 } from "@overcode-ai/core/project"
...
import { WorktreeEvent } from "@overcode-ai/schema/worktree-event"
...
export class Service extends Context.Service<Service, Interface>()("@overcode/Worktree") {}
  ...
  Effect.gen(function* () {
    ...
    const candidate = Effect.fn("Worktree.candidate")(function* (input: {
      ...
      for (const attempt of Array.from({ length: MAX_NAME_ATTEMPTS }, (_, i) => i)) {
        ...
        const branch = input.detached ? undefined : `overcode/${name}`
