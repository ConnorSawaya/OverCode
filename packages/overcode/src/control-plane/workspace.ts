...
import { EventSequenceTable, EventTable } from "@overcode-ai/core/event/sql"
...
import { WorkspaceEvent } from "@overcode-ai/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@overcode/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        OVERCODE_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        OVERCODE_WORKSPACE_ID: config.id,
        OVERCODE_EXPERIMENTAL_WORKSPACES: "true",
