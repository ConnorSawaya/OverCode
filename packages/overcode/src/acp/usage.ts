...
import type { AssistantMessage as OvercodeAssistantMessage, Message } from "@overcode-ai/sdk/v2"
import { InstanceRef } from "@/effect/instance-ref"
import { InstanceBootstrap } from "@/project/bootstrap"
import { InstanceStore } from "@/project/instance-store"
import { makeGlobalNode, Node } from "@overcode-ai/core/effect/app-node"
...
export type AssistantTokenCost = Pick<OvercodeAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<OvercodeAssistantMessage, "role"> &
  Partial<Pick<OvercodeAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@overcode/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@overcode/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@overcode/ACPUsage") {}
