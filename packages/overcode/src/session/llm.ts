...
import { llmClient } from "@overcode-ai/core/effect/app-node-platform"
...
import type { LLMEvent } from "@overcode-ai/llm"
import { LLMClient } from "@overcode-ai/llm/route"
import type { LLMClientService } from "@overcode-ai/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@overcode/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // from the workflow service are executed via overcode's tool system
      ...
      // Runtime seam: native is an opt-in adapter over @overcode-ai/llm. It
