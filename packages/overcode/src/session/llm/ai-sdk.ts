import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@overcode-ai/llm"
...
// Move this extraction into @overcode-ai/llm when Copilot is handled by the native runtime.
