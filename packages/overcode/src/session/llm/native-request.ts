import type { JsonSchema, LLMRequest, ProviderMetadata } from "@overcode-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@overcode-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @overcode-ai/llm request objects from overcode's session/AI SDK-shaped data.
  return LLM.request({
