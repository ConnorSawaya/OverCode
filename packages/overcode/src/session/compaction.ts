...
import { buildPrompt } from "@overcode-ai/core/session/compaction"
import { SessionCompactionEvent } from "@overcode-ai/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@overcode/SessionCompaction") {}
