...
import { Usage, type LLMEvent } from "@overcode-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@overcode/SessionProcessor") {}
      ...
      const handleEvent = Effect.fnUntraced(function* (value: StreamEvent) {
        switch (value.type) {
          ...
          case "step-finish": {
            ...
            // prompt. Prefix mismatches mean overcode changed history behind a signed
