...
import { ProjectDirectoryTable, ProjectTable } from "@overcode-ai/core/project/sql"
import { ProjectDirectories } from "@overcode-ai/core/project/directories"
...
import { which } from "@overcode-ai/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@overcode/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.OVERCODE_FAKE_VCS)
