...
import { AbsolutePath, type DeepMutable } from "@overcode-ai/core/schema"
...
import { Reference } from "@overcode-ai/core/reference"
...
export class Service extends Context.Service<Service, Interface>()("@overcode/Agent") {}
          ...
          plan: {
            ...
            permission: Permission.merge(
              ...
              Permission.fromConfig({
                ...
                edit: {
                  "*": "deny",
                  [path.join(".overcode", "plans", "*.md")]: "allow",
