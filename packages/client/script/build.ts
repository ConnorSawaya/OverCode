...
import { compile, emitEffectImported, emitPromise, write } from "@overcode-ai/httpapi-codegen"
    ...
    [
      write(
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              name: "OvercodeEventEncoded",
              import: 'import type { OvercodeEventEncoded } from "@overcode-ai/protocol/groups/event"',
            },
          },
        }),
