...
const GLOBAL_STORAGE = "overcode.global.dat"
const WINDOW_STORAGE = "overcode.window"
const LOCAL_PREFIX = "overcode."
...
function workspaceStorage(dir: string) {
  ...
  return `overcode.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `overcode.draft.${head}.${sum}.dat`
}
