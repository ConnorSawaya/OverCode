...
export const dict = {
  ...
  "settings.mobileAccess.codeLabel": "Eight-digit pairing code",
  ...
  "settings.mobileAccess.pairingDescription":
    "Keep Overcode open while you use the phone app. Revoke this code if the phone is lost.",
  ...
  "settings.mobileAccess.error.secureStorage":
    "This PC cannot access secure storage, so mobile access was not started.",
  ...
  "settings.syncDevices.connectDescription": "Enter the eight-digit code shown on the device you want to connect.",
  "settings.syncDevices.codePlaceholder": "4829 1735",
  ...
  "settings.syncDevices.invalidCode": "Enter a valid eight-digit pairing code.",
  ...
  "mobile.pairing.description":
    "Enter the eight-digit code shown in Overcode on your PC, or scan its QR code. The code works once and expires in 5 minutes.",
  "mobile.pairing.placeholder": "4829 1735 or overcode://mobile?...",
  "mobile.pairing.inputLabel": "Eight-digit pairing code or URI",
  ...
  "mobile.pairing.cameraDenied":
    "Camera access was not available. Allow camera access or paste the pairing URI instead.",
  ...
  "settings.general.row.theme.customTitle": "Custom themes",
  "settings.general.row.theme.customDescription":
    "Import a JSON theme file or a trusted HTTP(S) URL. It stays on this device.",
  "settings.general.row.theme.urlPlaceholder": "Theme URL (https://...)",
  "settings.general.row.theme.import": "Import theme",
  "settings.general.row.theme.file": "Open JSON",
  "settings.general.row.theme.remove": "Remove",
