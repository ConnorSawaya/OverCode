...
beforeAll(async () => {
  ...
  mock.module("@overcode-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@overcode-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@overcode-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@overcode-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
