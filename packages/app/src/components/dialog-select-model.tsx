...
import { isOvercodeProvider, popularProviders } from "@/hooks/use-providers"
...
import { List } from "@overcode-ai/ui/list"
import { Tooltip } from "@overcode-ai/ui/tooltip"
import { Icon } from "@overcode-ai/ui/v2/icon"
import { Tag as TagV2 } from "@overcode-ai/ui/v2/badge-v2"
...
const isFree = (provider: string, cost: { input: number } | undefined) =>
  isOvercodeProvider(provider) && (!cost || cost.input === 0)
