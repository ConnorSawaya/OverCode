...
import {
  ...
  type StatsModelData,
} from "@overcode-ai/stats-core/domain/home"
import { statModel } from "@overcode-ai/stats-core/domain/model-normalization"
...
export default function StatsModel() {
  ...
  return (
    <main data-page="stats" data-theme={themePreference()}>
      ...
      <Meta property="og:site_name" content="Overcode" />
      ...
      >
        {(data) => (
          <p data-slot="model-hero-rankline">
            ...
            <span data-slot="model-hero-pill">Overcode</span>
