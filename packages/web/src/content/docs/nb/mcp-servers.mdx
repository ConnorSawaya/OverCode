...
Du kan definere MCP-servere i [Overcode Config](https://github.com/ConnorSawaya/overcode/tree/plain-cli/packages/web/src/content/docs/config/) under `mcp`. Legg til hver MCP med et unikt navn. Du kan referere til den MCP ved navn når du spør LLM-en.
