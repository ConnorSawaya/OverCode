...
Уровни: `debug`, `info`, `warn`, `error`. Подробности см. в документации SDK](https://github.com/ConnorSawaya/overcode/tree/plain-cli/packages/web/src/content/docs/sdk).
