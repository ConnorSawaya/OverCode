...
Niveauer: `debug`, `info`, `warn`, `error`. Se [SDK documentation](https://github.com/ConnorSawaya/overcode/tree/plain-cli/packages/web/src/content/docs/sdk) for detaljer.
