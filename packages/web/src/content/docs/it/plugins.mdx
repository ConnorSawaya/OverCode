...
Livelli: `debug`, `info`, `warn`, `error`. Vedi la [documentazione SDK](https://github.com/ConnorSawaya/overcode/tree/plain-cli/packages/web/src/content/docs/sdk) per i dettagli.
