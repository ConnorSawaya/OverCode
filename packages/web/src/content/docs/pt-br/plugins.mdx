...
Níveis: `debug`, `info`, `warn`, `error`. Veja a [documentação do SDK](https://github.com/ConnorSawaya/overcode/tree/plain-cli/packages/web/src/content/docs/sdk) para detalhes.
