...
import { IconOvercode } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "overcode/session/message-v2"
import type { Message } from "overcode/session/message"
import type { Session } from "overcode/session/session"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.overcode_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.overcode_name}>
                    <IconOvercode width={16} height={16} />
                  </div>
