...
import { FileSystemWatcher } from "@overcode-ai/schema/filesystem-watcher"
...
declare const OVERCODE_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof OVERCODE_LIBC === "undefined" ? undefined : OVERCODE_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@overcode/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.OVERCODE_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.OVERCODE_EXPERIMENTAL_FILEWATCHER)) {
