...
import type { Data, Definition, Payload } from "@overcode-ai/schema/event"
...
export type ID = import("@overcode-ai/schema/event").ID
export type { Data, Definition, Payload } from "@overcode-ai/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@overcode/Event") {}
