...
import { Entry, FileSystem, FindInput, Match } from "@overcode-ai/schema/filesystem"
export { Entry, Match, Submatch } from "@overcode-ai/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@overcode/v2/FileSystem") {}
