...
import { Event } from "@overcode-ai/schema/project-directories"
import { ProjectCopy } from "@overcode-ai/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@overcode/ProjectCopy") {}
