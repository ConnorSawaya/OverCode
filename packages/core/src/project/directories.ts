...
import type { EffectDrizzleSqlite } from "@overcode-ai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@overcode/ProjectDirectories") {}
