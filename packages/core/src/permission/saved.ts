...
import { PermissionSaved } from "@overcode-ai/schema/permission-saved"
...
export class Service extends Context.Service<Service, Interface>()("@overcode/v2/PermissionSaved") {}
