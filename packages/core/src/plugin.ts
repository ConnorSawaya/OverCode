...
import type { Plugin as PluginRuntime } from "@overcode-ai/plugin/v2/effect"
...
export class Service extends Context.Service<Service, Interface>()("@overcode/v2/Plugin") {}
