...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@overcode-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@overcode/v2/ToolRegistry") {}
