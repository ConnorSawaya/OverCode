...
import { ProviderPlugins } from "@overcode-ai/core/plugin/provider"
import { ZenmuxPlugin } from "@overcode-ai/core/plugin/provider/zenmux"
...
describe("ZenmuxPlugin", () => {
  ...
  it.effect("applies the exact legacy Zenmux headers", () =>
    Effect.gen(function* () {
      ...
      expect(result.request.headers).toEqual({ "HTTP-Referer": "https://github.com/ConnorSawaya/overcode/", "X-Title": "overcode" })
