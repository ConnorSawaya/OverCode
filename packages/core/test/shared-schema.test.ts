...
import { AgentAttachment, FileAttachment, Prompt, Source } from "@overcode-ai/schema/prompt"
import { Provider } from "@overcode-ai/schema/provider"
import { Project } from "@overcode-ai/schema/project"
import { ProjectDirectories } from "@overcode-ai/schema/project-directories"
import { PermissionV1 } from "@overcode-ai/schema/permission-v1"
...
import { Command } from "@overcode-ai/schema/command"
import { Connection } from "@overcode-ai/schema/connection"
import { Credential } from "@overcode-ai/schema/credential"
import { FileSystem } from "@overcode-ai/schema/filesystem"
import { Integration } from "@overcode-ai/schema/integration"
import { LLM } from "@overcode-ai/schema/llm"
import { Permission } from "@overcode-ai/schema/permission"
import { Plugin } from "@overcode-ai/schema/plugin"
import { Pty } from "@overcode-ai/schema/pty"
import { Reference } from "@overcode-ai/schema/reference"
import { SessionTodo } from "@overcode-ai/schema/session-todo"
import { Skill } from "@overcode-ai/schema/skill"
import { AbsolutePath, DateTimeUtcFromMillis, optional, statics } from "@overcode-ai/schema/schema"
...
test("Core reuses the canonical shared schemas", async () => {
  const [
    ...
    import("@overcode-ai/core/command"),
    import("@overcode-ai/core/integration/connection"),
    import("@overcode-ai/core/credential"),
    import("@overcode-ai/core/filesystem"),
    import("@overcode-ai/core/integration"),
    import("@overcode-ai/core/location"),
    import("@overcode-ai/llm"),
    import("@overcode-ai/core/permission"),
    import("@overcode-ai/core/v1/permission"),
    import("@overcode-ai/core/project/copy"),
    import("@overcode-ai/core/pty"),
    import("@overcode-ai/core/project/schema"),
    import("@overcode-ai/core/reference"),
    import("@overcode-ai/core/session/input"),
    import("@overcode-ai/core/session/message"),
    import("@overcode-ai/core/session/todo"),
    import("@overcode-ai/core/session/prompt"),
    import("@overcode-ai/core/skill"),
    import("@overcode-ai/core/v2-schema"),
    import("@overcode-ai/core/schema"),
    import("@overcode-ai/core/workspace"),
  ])
