import { convertToOpenAICompatibleChatMessages as convertToCopilotMessages } from "@overcode-ai/core/github-copilot/chat/convert-to-openai-compatible-chat-messages"
