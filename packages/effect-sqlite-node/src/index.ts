...
export const TypeId: TypeId = "~@overcode-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@overcode-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@overcode-ai/effect-sqlite-node/NodeSqliteClient")
