...
const icons = {
  ...
  microphone: {
    viewBox: "0 0 16 16",
    body: `<path d="M8 2.25C6.89543 2.25 6 3.14543 6 4.25V8.25C6 9.35457 6.89543 10.25 8 10.25C9.10457 10.25 10 9.35457 10 8.25V4.25C10 3.14543 9.10457 2.25 8 2.25Z" stroke="currentColor"/><path d="M3.75 7.25V8.25C3.75 10.5972 5.65279 12.5 8 12.5C10.3472 12.5 12.25 10.5972 12.25 8.25V7.25M8 12.5V14M5.75 14H10.25" stroke="currentColor" stroke-linecap="round"/>`,
  },
  waveform: {
    viewBox: "0 0 16 16",
    body: `<path d="M3 7V9M5 5V11M7 3.75V12.25M9 5V11M11 4.5V11.5M13 7V9" stroke="currentColor" stroke-linecap="round" stroke-width="1.25"/>`,
  },
  shield: {
    viewBox: "0 0 16 16",
    body: `<path d="M8 1.75L13 3.45V7.25C13 10.15 10.95 12.55 8 14.25C5.05 12.55 3 10.15 3 7.25V3.45L8 1.75Z" stroke="currentColor" stroke-linejoin="round"/><path d="M5.75 7.9L7.25 9.4L10.5 6.15" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>`,
  },
  "settings-gear": {
    viewBox: "0 0 16 16",
  ...
  mobile: {
    viewBox: "0 0 16 16",
    body: `<rect x="4" y="1.5" width="8" height="13" rx="1.5" stroke="currentColor"/><path d="M6.5 3.5H9.5M7.25 12.25H8.75" stroke="currentColor" stroke-linecap="round"/>`,
  },
  "workspace-new": {
    viewBox: "0 0 16 16",
  ...
  pin: {
    viewBox: "0 0 16 16",
    body: `<path d="M6 2.5h4M6 2.5l1.4 5.8M10 2.5L8.6 8.3M7.4 8.3L8 13.5M8.6 8.3L8 13.5" stroke="currentColor" stroke-linecap="square"/>`,
  },
}

const spriteID = "overcode-v2-icon-sprite"
const symbol = (name: keyof typeof icons) => `overcode-v2-icon-${name}`
